...
<head runat="server">
    ...
    <title>Online Charity Management</title>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center justify-content-between no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="Index.aspx">
                                    <img src="img/CharityLogo.png.png" width="100" height="100" alt="">
                                </a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="about_info">
                        <h3>We are Online Charity Management to help NGO of across all over India
                            <br>
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    <div class="about_text_info">
                        <p>
                            The main target of Online Charity Management is to maintain the NGO fraud.
